...
a,b,c= 1,2,[{key:value for key,value in enumerate([{"key":1}]*5)}]*10
print(a,b,c)
#typings
Scalar =  List[Union[int,str,dict]]
# namedScalar: Scalar = [12,'',{}]
...
#         return [tup,dict]
#
# print(hugeComputation((1,2,23,3,2),{"soemthing":212},[12,12,33,34,21,34,4,5]),namedScalar)